...
const TokenType SLANG_COMPUTATION = "COMPUTATION";
const TokenType SLANG_COMPUTATION_SETUP = "COMPUTATION_SETUP";
const TokenType SLANG_COMPUTATION_RUN = "COMPUTATION_RUN";
const TokenType SLANG_SIGNAL_GENERATOR = "SIGNAL_GENERATOR";
const TokenType SLANG_PHASOR = "PHASOR";
...
const TokenType SLANG_PATTERN = "PATTERN";
