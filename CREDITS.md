All code original by Thorsten Sideboard, but heavily influenced by several books.
...
JSON preset serialization uses [nlohmann/json](https://github.com/nlohmann/json) by Niels Lohmann (MIT license).
